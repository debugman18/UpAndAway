...
SHOPKEEPER.IS_A_COW = function(inst)
	return inst.prefab == "beefalo" or inst.prefab == "ox" or inst.prefab == "mandrakeman"
end
...
OWL.REPUTATION.FRIEND_THRESHOLD = 90
OWL.REPUTATION.FOOD_THRESHOLD = 65 -- When the player can give food.
OWL.REPUTATION.CRYSTAL_THRESHOLD = 35 -- When the player can give crystals.
OWL.REPUTATION.DEATH = -4
OWL.REPUTATION.HOME_WORKED_MINOR = -20
OWL.REPUTATION.HOME_WORKED_MAJOR = -5
OWL.REPUTATION.CRYSTAL_WORKED = -10
OWL.REPUTATION.CRYSTAL_GIVEN = 5
OWL.REPUTATION.FOOD_GIVEN = 4
OWL.REPUTATION.ENEMY_KILLED = 5
OWL.REPUTATION.FRIEND_KILLED = -2
...
OCTOCOPTER.TARGET_DIST = 14
OCTOCOPTER.RANGE = 6
OCTOCOPTER.HEALTH = 3000
OCTOCOPTER.ATTACK_PERIOD = math.random(2,5)
...
BEANLET.SCALE = 1
BEANLET_ZEALOT.SCALE = 1.0
BEANLET_ZEALOT.SCALE_INVERT = -1.0

BEANLET.WALKSPEED = 4
BEANLET.RUNSPEED = 8

BEANLET_ZEALOT.WALKSPEED = 1
BEANLET_ZEALOT.RUNSPEED = 1
...
LIVE_GNOME.RUN_START_DIST = 15
LIVE_GNOME.RUN_STOP_DIST = 20

LIVE_GNOME.MAX_WANDER_DIST = 20
LIVE_GNOME.MAX_CHASE_TIME = 10

LIVE_GNOME.MIN_FOLLOW_DIST = 20
LIVE_GNOME.MAX_FOLLOW_DIST = 50
...
LIVE_GNOME.SUMMON_DELAY = 40
LIVE_GNOME.MAX_SUMMONS = 4
...
-- This balances all of the variables at the same time. The broadest of changes. Comprehensive.
CLOUD_BLOB.BALANCE_COMP = 1

-- This balances all of the combat variables.
CLOUD_BLOB.BALANCE_COMBAT = 1

CLOUD_BLOB.HEALTH = 4 * CLOUD_BLOB.BALANCE_COMP * CLOUD_BLOB.BALANCE_COMBAT
CLOUD_BLOB.ATTACK = 10 * CLOUD_BLOB.BALANCE_COMP * CLOUD_BLOB.BALANCE_COMBAT
CLOUD_BLOB.SPEED = 2 * CLOUD_BLOB.BALANCE_COMP * CLOUD_BLOB.BALANCE_COMBAT

CLOUD_BLOB.CHILD = "cloud_blob"
CLOUD_BLOB.MAX_CHILDREN = 2 * CLOUD_BLOB.BALANCE_COMP
CLOUD_BLOB.MAX_ONSCREEN = 50 * CLOUD_BLOB.BALANCE_COMP
CLOUD_BLOB.DISTORT = 3 * CLOUD_BLOB.BALANCE_COMP
CLOUD_BLOB.DROPPED_SCALE = 1 * CLOUD_BLOB.BALANCE_COMP
CLOUD_BLOB.DROP_PERIOD = 60 * CLOUD_BLOB.BALANCE_COMP
CLOUD_BLOB.PLANTED_SCALE = 3 * CLOUD_BLOB.BALANCE_COMP
CLOUD_BLOB.INIT_SCALE = 10 * CLOUD_BLOB.BALANCE_COMP
CLOUD_BLOB.MOD_SCALE = 0.5 * CLOUD_BLOB.BALANCE_COMP
CLOUD_BLOB.SCALE_FLOOR = 1 * CLOUD_BLOB.BALANCE_COMP
CLOUD_BLOB.CHARGED_SCALE = 30 * CLOUD_BLOB.BALANCE_COMP
CLOUD_BLOB.CHASE_DIST = 5 * CLOUD_BLOB.BALANCE_COMP
CLOUD_BLOB.SEE_DIST = 20 * CLOUD_BLOB.BALANCE_COMP

CLOUD_BLOB.COLOR = function() return 0.1 + math.random() * 0.9 end
CLOUD_BLOB.ALPHA = function() return 0.5 + math.random() end
