...
local weather_machine = Recipe("weather_machine", { Ingredient("gears", 4), Ingredient("crystal_fragment_relic", 6, "images/inventoryimages/crystal_fragment_relic.xml") }, RECIPETABS.SCIENCE, TECH.FABLE_1)
...
local grabber = Recipe("grabber", { Ingredient("magnet", 2, "images/inventoryimages/cloud_cotton.xml"), Ingredient("cane", 1), Ingredient("rubber", 4, "images/inventoryimages/cloud_cotton.xml") }, RECIPETABS.TOOLS, TECH.FABLE_1)
grabber.atlas = "images/winnie.xml"

local magnet = Recipe("magnet", { Ingredient("gears", 2), Ingredient("crystal_fragment", 3, "images/inventoryimages/cloud_cotton.xml") }, RECIPETABS.SCIENCE, TECH.FABLE_1)
magnet.atlas = "images/winnie.xml"

local crystal_lamp = Recipe("crystal_lamp", { Ingredient("beanlet_shell", 1, "images/inventoryimages/cloud_cotton.xml"), Ingredient("crystal_fragment", 4, "images/inventoryimages/cloud_cotton.xml") }, RECIPETABS.LIGHT, TECH.FABLE_1)
...
local black_crystal_staff = Recipe("blackstaff", { Ingredient("spear", 1), Ingredient("refined_black_crystal", 1, "images/inventoryimages/cloud_cotton.xml") }, RECIPETABS.MAGIC, TECH.FABLE_1)
black_crystal_staff.atlas = "images/winnie.xml"

local white_crystal_staff = Recipe("whitestaff", { Ingredient("spear", 1), Ingredient("refined_white_crystal", 1, "images/inventoryimages/cloud_cotton.xml") }, RECIPETABS.MAGIC, TECH.FABLE_1)
