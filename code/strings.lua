...
Add.QuotesFor "beanstalk" {
    ...
    wx78 = "I CANNOT CALCULATE ITS HEIGHT",
}
...
Add.QuotesFor "datura_petals" {
    ...
    wx78 = "IT SMELLS LIKE FLESHLINGS",
}
...
Add.QuotesFor "skyflower" {
    ...
    wx78 = "IT SMELLS LIKE DESTRUCTION",
}
