...
local function make_test_turf(name, data, fakename)
    ...
    STRINGS.NAMES["TURF_" .. name:upper()] = fakename:gsub("^%a", string.upper) .. " Turf"
...
for _, v in ipairs(new_tiles) do
    table.insert(cloud_turf, make_test_turf("poopcloud", {anim = "carpet", imagename = "turf_carpetfloor"}, "Cloud Fill"))
    table.insert(cloud_turf, make_test_turf("cloudswirl", {anim = "carpet", imagename = "turf_carpetfloor"}, "Cloudswirl"))
    table.insert(cloud_turf, make_test_turf("cloudland", {anim = "carpet", imagename = "turf_carpetfloor"}, "Cloudland"))
    table.insert(cloud_turf, make_test_turf("aurora", {anim = "carpet", imagename = "turf_carpetfloor"}, "Aurora"))
    table.insert(cloud_turf, make_test_turf("auroratwo", {anim = "carpet", imagename = "turf_carpetfloor"}, "Borealis"))
    table.insert(cloud_turf, make_test_turf("snow", {anim = "carpet", imagename = "turf_carpetfloor"}, "Snowy"))
    table.insert(cloud_turf, make_test_turf("snowtwo", {anim = "carpet", imagename = "turf_carpetfloor"}, "Icecream"))
    table.insert(cloud_turf, make_test_turf("rainbow", {anim = "carpet", imagename = "turf_carpetfloor"}, "Rainbow"))
    table.insert(cloud_turf, make_test_turf("rainbowtwo", {anim = "carpet", imagename = "turf_carpetfloor"}, "Sherbert"))
end
