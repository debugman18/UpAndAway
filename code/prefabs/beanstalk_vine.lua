...
SetSharedLootTable( "beanstalk_vine", CFG.VINE.LOOT)
...
local function Retarget(inst)
    local newtarget = FindEntity(inst, 20, function(guy)
            return (guy:HasTag("character") or guy:HasTag("monster"))
                   ...
                   and not guy:HasTag("beanstalk_vine")
...
local function fn(Sim)
    ...
    inst.components.lootdropper:SetChanceLootTable("beanstalk_vine")
...
return Prefab("cloudrealm/monsters/beanstalk_vine", fn, assets, prefabs) 
