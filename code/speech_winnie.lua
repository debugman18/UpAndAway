return {
	ACTIONFAIL =
	{
		REPAIRBOAT =
		{
			GENERIC = "Why fix what's not broken?", --SW
		},
		SHAVE =
		{
	...
	ANNOUNCE_BOAT_DAMAGED = "I don't think my boat is okay...", --SW
	ANNOUNCE_BOAT_SINKING = "I should get a life vest. It's what grandpa would do.", --SW
	ANNOUNCE_BOAT_SINKING_IMMINENT = "Am I sinking?", --SW
	ANNOUNCE_BOOMERANG = "Ouch.", --w
	ANNOUNCE_CHARLIE = "Hello?", --w
	ANNOUNCE_CHARLIE_ATTACK = "Ahh! Monster!!", --w
	ANNOUNCE_COLD = "So Cold!",
	ANNOUNCE_CRAB_ESCAPE = "Where did the little crabby go?", --SW
	...
	ANNOUNCE_MAPWRAP_LOSECONTROL = "It's out of my hands now.", --SW
	ANNOUNCE_MAPWRAP_RETURN = "Am I back home?", --SW
	ANNOUNCE_MAPWRAP_WARN = "What's going on?", --SW
	ANNOUNCE_MESSAGEBOTTLE = --SW
	{
		"It's all smudged. I can't read it.",
	},
	ANNOUNCE_MORETREASURE = "Look! I found more goodies!!", --SW
	...
	ANNOUNCE_OTHER_WORLD_PLANT = "No. That shouldn't be here.", --SW
	ANNOUNCE_OTHER_WORLD_TREASURE = "I haven't been there yet.", --SW
	...
	ANNOUNCE_SHARX = "I hear mean fishies.", --SW
	ANNOUNCE_THORNS = "Ow!",
	ANNOUNCE_TORCH_OUT = "Almost burned my hand.", --W
	ANNOUNCE_TRAP_WENT_OFF = "Oops.",
	ANNOUNCE_TRAWL_FULL = "It's full already.", --SW
	ANNOUNCE_TREASURE = "Let's go treasure hunting!", --SW
	ANNOUNCE_UNIMPLEMENTED = "OW! I don't think it's ready yet.",
	ANNOUNCE_VOLCANO_ERUPT = "I should find a table to hide under!", --SW
	ANNOUNCE_WAVE_BOOST = "I'm the fastest!", --SW
	ANNOUNCE_WORMHOLE = "It was yucky in there.", --w
	ANNOUNCE_CANFIX = "\nI think I can fix this!",
	ANNOUNCE_WHALE_HUNT_BEAST_NEARBY = "I'm getting close to something.", --SW
	ANNOUNCE_WHALE_HUNT_LOST_TRAIL = "I think I lost it.", --SW
	ANNOUNCE_WHALE_HUNT_LOST_TRAIL_SPRING = "It isn't easy to find things with all this rain.", --SW
	...
	DESCRIBE =
	{
		...
		TURF_ROCKY = "Dirt as hard as rock.", --w
		...
		BOAT = "I can't sail on that one...", --w
		...
		DUG_BERRYBUSH = "I should plant this somewhere.", --w
		DUG_GRASS = "I should plant this somewhere.", --w
		DUG_MARSH_BUSH = "I should plant this somewhere.", --w
		...
		PANDORASCHEST = "Maybe it should remain closed.", --w
		...
		PLANT_NORMAL =
		{
			...
			WITHERED = "Drought destroys even the best crops.", --w
		},
		...
		RESEARCHLAB4 = "And for my next trick...", --w
		...
		SUNKBOAT = "The boat of some unlucky sailor.", --w
		...
		TREASURECHEST_TRAP = "Today must be my lucky day!", --w
		TREECLUMP = "I'm stumped now.", --w
		...
		UNIMPLEMENTED = "I shouldn't mess with the unknown...", --w
		WAFFLES = "Delicious!", --w
		...
		WORMHOLE =
		{
			...
			OPEN = "Itâ€™s full of teeth. But where does it go?", --w
		},
		WORMHOLE_LIMITED = "It has a cold.", --w
		ACCOMPLISHMENT_SHRINE = "I'll make grandma proud of me!", --w
		...
		MOOSE = "A living mystery.", --w
		MOOSEEGG = "Will it hatch soon?", --w
		MOSSLING = "So adorable!", --w
		FEATHERFAN = "I could tickle many things with this.", --w
		GOOSE_FEATHER = "Tickle tickle.", --w
		STAFF_TORNADO = "The wind will protect me.", --w
		RAINCOAT = "It keeps the rain away from my body.", --w
		ROCK_ICE = 
		{
			GENERIC = "A sinker of ships.", --w
			MELTED = "It melted away.", --w
		},
		ROCK_ICE_MELTED = "It melted away.", --w
		ICE = "Good for putting on drinks.", --w
		SKELETON_PLAYER = "It's me!", --w
		REFLECTIVEVEST = "I'll send the sun right back at itself.", --w
		HAWAIIANSHIRT = "I didn't know I was on vacation.", --w
		SIESTAHUT = 
		{
			GENERIC = "I think grandma would be proud of me if she could see this.", --w
			BURNT = "Oh no!", --w
		},
		TRANSISTOR = "I don't know how I made this.", --w
		TUMBLEWEED = "Give me a home, where the Beefalo roam.",
		GRASS_UMBRELLA = "The prettiest parasol.", --w
		...
		--ShipWrecked
		TRINKET_13 = "It doesn't look like orange juice.", --Orange Soda
		TRINKET_14 = "Grandma warned me never to play with things like this.", --Voodoo Doll
		TRINKET_15 = "Grandpa knows how to play it.", --Ukulele
		TRINKET_16 = "What do these numbers and letters mean?", --License Plate
		TRINKET_17 = "Old and musty. And I don't even have the other foot.", --Old Boot
		TRINKET_18 = "Looks like the ones grandma doesn't like me to touch.", --Ancient Vase
		TRINKET_19 = "Will it help me forget the heavens?", --Brain Cloud Pill
		TRINKET_20 = "Is this... some kind of toy?", --Sextant
		TRINKET_21 = "A cute toy boat.", --Toy Boat
		TRINKET_22 = "It's soaked wet.", --Soaked Candle
		TRINKET_23 = "I think it's broken...", -- AAC = Augmentative and Alternative Communication
		AERODYNAMICHAT = "Makes me run way faster!",
		ANTIVENOM = "It'll help me heal if I get sick.",
		ARMORLIMESTONE = "It makes my back hurt.",
		ARMOROBSIDIAN = "It burns my back a bit.",
		ARMORSEASHELL = "It's pretty.",
		ARMOR_LIFEJACKET = "Grandpa would've liked me to wear it.",
		ARMOR_SNAKESKIN = "Wearing this makes me feel weird...",
		ARMOR_WINDBREAKER = "And he'll huff and he'll puff but he won't blow me away.",
		ARMOUREDBOAT = "It makes me feel safe.",
		BABYOX = "It's adorably soggy.",
		BALLPHIN = "Do you want to play with me?",
		BAMBOO = "Would these do for stick swords?",
		BAMBOOTREE =
		{
			BURNT = "No more stick swords for me.",
			CHOPPED = "I hope it grows back soon.",
			GENERIC = "Is there a fairytale about bamboo?",
		},
		BERMUDATRIANGLE = "I've heard many tales about it... none were good.",
		BIOLUMINESCENCE = "So pretty...",
		BLOWDART_FLUP = "I spy with my little eye...",
		BLOWDART_POISON = "I feel bad for using this...",
		BLUBBER = "Ew...",
		BLUBBERSUIT = "So squishy.",
		BOATCANNON = "Violence is never the answer.",
		BOATREPAIRKIT = "Can I fix it? Yes I can!",
		BOAT_LANTERN = "My night-boat-light.",
		BOAT_TORCH = "Light my way up.",
		BOTTLELANTERN = "Twinkle, twinkle, little bottle.",
		BUOY = "Safety first.",
		BURIEDTREASURE = "What secrets will I uncover?",
		BUSH_VINE =
		{
			BURNT = "Oops...",
			CHOPPED = "Not very spiky now.",
			GENERIC = "Looks way too pointy.",
		},
		CAPTAINHAT = "It makes me feel like a real captain.",
		CARGOBOAT = "A toy-chest boat.",
		CHIMINEA = "High up, no water. Closed up, no wind.",
		CLOTHSAIL = "Should I set sail?",
		COCONADE =
		{
			BURNING = "It's going to go \"boom\" soon...",
			GENERIC = "It goes \"BOOM\"!",
		},
		COCONUT = "For vacations on the sea-side.",
		COCONUT_COOKED = "It tastes a bit better now.",
		COFFEE = "Like tea, but less delicate.", -- "Grandma told me I can't drink this just yet."
		COFFEEBEANS = "I don't think these are sunflower seeds...",
		COFFEEBEANS_COOKED = "I think it needs some hot water.",
		COFFEEBOT = "Is there a tea bot too?",
		COFFEEBUSH =
		{
			BARREN = "Coffee also needs to be fertilized.",
			GENERIC = "I wish it was a tea bush.",
			PICKED = "I'll have to wait for more coffee.",
			WITHERED = "I don't think the sun likes coffee.",
		},
		CORAL = "It has pretty colours.",
		CORALREEF = "A pretty rock.",
		CORAL_BRAIN = "You can't outsmart me.",
		CORAL_BRAIN_ROCK = "What a brainyak.",
		CRAB =
		{
			GENERIC = "Blue like the ocean.",
			HIDDEN = "Why is it so afraid?",
		},
		CRABHOLE = "It's a crab's happy home.",
		CUTLASS = "I don't like holding this...",
		DEAD_SWORDFISH = "I'm sorry.",
		DOUBLE_UMBRELLAHAT = "... Creative?", -- "Grandpa used to make some weird things like this."
		DOYDOY = "What a goof.",
		DOYDOYBABY = "He's such a cute goofy!",
		DOYDOYEGG = "I should give it back to its parents.",
		DOYDOYEGG_CRACKED = "Is... is it okay?",
		DOYDOYFEATHER = "A feather coloured like the ocean.",
		DOYDOYNEST = "Those goof birds hatch from there.",
		DRAGOON = "I think he needs a diet.",
		DRAGOONDEN = "Are those things fat or just full of muscles?",
		DRAGOONEGG = "Did it just move?",
		DUBLOON = "I could buy a thousand toys with this!",
		DUG_BAMBOOTREE = "I should plant this somewhere.",
		DUG_COFFEEBUSH = "I still prefer tea.",
		DUG_ELEPHANTCACTUS = "I should plant this somewhere.",
		EARRING = "I'm too young to use this.",
		ELEPHANTCACTUS = "I don't like the looks of it.",
		ELEPHANTCACTUS_ACTIVE = "Why does it hate me?",
		...
		FLAMEGEYSER = "I should stay away from it.",
		FLOTSAM = "The piece of an unlucky ship.",
		FLUP = "Is it watching me?",
		FROG_POISON = "Poisonous ribbit.",
		GASHAT = "It makes me look scary.",
		GOLDENMACHETE = "My own golden sword!",
		HAIL_ICE = "It fell from the world above.",
		ICEMAKER =
		{
			HIGH = "It's making lots of ice!",
			LOW = "It's not going to work for much longer.",
			NORMAL = "It makes ice for me.",
			OUT = "It won't work without fuel.",
			VERYLOW = "It's almost done with its ice-making business.",
		},
		IRONWIND = "What an industrial revolution.",
		JELLYFISH = "It blobs around and around.",
		JELLYFISH_COOKED = "Eugh. No.",
		JELLYFISH_DEAD = "No! It's dead!",
		JELLYFISH_PLANTED = "I have to be careful not to step on it.",
		JELLYJERKY = "I think I lost my appetite...",
		JUNGLETREE =
		{
			BURNING = "Oh no!",
			BURNT = "The cycle of life will continue.",
			CHOPPED = "Stumps don't grow, silly.",
			GENERIC = "Full of snakeys.",
		},
		JUNGLETREESEED = "Soon it won't be so small.",
		KNIGHTBOAT = "Horsey boat-y!",
		LAVAPOOL = "One misstep and I might fall there...",
		LIMESTONE = "Pretty heavy.",
		LIMPETROCK =
		{
			GENERIC = "It's full of snails!",
			PICKED = "The snails are all mine now.",
		},
		LIMPETS = "I don't think they like me much.",
		LIVINGJUNGLETREE = "That face doesn't look scary.",
		LOBSTER = "I'm scaring it.",
		LOBSTERHOLE = "It's the lobster's home.",
		LOBSTER_DEAD = "What did I do?",
		LOBSTER_DEAD_COOKED = "Blech. No.",
		LOGRAFT = "It looks weak and dangerous...",
		LUGGAGECHEST = "Will I find more golden coins inside?",
		MACHETE = "Grandpa had one of these.",
		MAGIC_SEAL = "This... makes me sad.",
		MAGMAROCK = "Hot rocks.",
		MAGMAROCK_GOLD = "Hot gold rocks.",
		MANGROVETREE = "How does it breathe underwater?",
		MANGROVETREE_BURNT = "It's not breathing anymore...",
		MARSH_PLANT_TROPICAL = "It's a tropical plant.",
		MERMFISHER = "It's really good at fishing. After all, it's all it does.",
		MERMHOUSE_FISHER = "I could smell it from miles.",
		MESSAGEBOTTLE = "What message lies inside?",
		MESSAGEBOTTLEEMPTY = "Nothing's inside it.",
		MOSQUITOSACK_YELLOW = "It looks bad, but it does me good.",
		MOSQUITO_POISON = "It carries a sickness. But which one?",
		MUSSEL = "I mussay you look good today.",
		MUSSEL_COOKED = "What have I done?",
		MUSSEL_FARM =
		{
			GENERIC = "I'm sticking them up.",
			STICKPLANTED = "They take a while to stick on the stick.",
		},
		MUSSEL_STICK = "Perfect for stick swords!",
		NEEDLESPEAR = "I'd never lose this in a haystack.",
		OBSIDIAN = "Very hot to the touch.",
		OBSIDIANAXE = "It belongs to Paul Bunyan's evil twin.",
		OBSIDIANCOCONADE = "Grandpa would never let me get near something like this.",
		OBSIDIANFIREPIT = "If I tried to toast marshmallows here, they'd burn.",
		OBSIDIANMACHETE = "I hope I don't burn my hands with it.",
		OBSIDIANSPEARGUN = "This is so cruel...",
		OBSIDIAN_WORKBENCH = "I can learn hot new things.",
		OCTOPUSCHEST = "What's inside is a mystery.",
		OCTOPUSKING = "He looks bored.",
		OX = "It's some kind of water cow.",
		PACKIM = "Birdy wants a fishie?",
		PACKIM_FISHBONE = "Packim's favorite fish bone.",
		PALMLEAF = "They are too big for me to fan myself with.",
		PALMLEAF_HUT = "Grandma would be proud of me if she knew I built this up.",
		PALMLEAF_UMBRELLA = "Staying under it makes me feel fresh.",
		PALMTREE = "Reminds me of how grandpa loved to lay on hammocks.",
		PARROT = "He's red like the sunset.",
		PEACOCK = "I always wanted to have one like that.",
		PIKE_SKULL = "Owie.",
		PIRATEHAT = "I'm now the captain of the seven seas!",
		PIRATEPACK = "For my school supplies and my golden coins.",
		PIRATIHATITATOR =
		{
			BURNT = "No more magic tricks will be coming from that.",
			GENERIC = "Will I pull a rabbit or a parrot out?",
		},
		POISONHOLE = "This hole must be sick.",
		PORTAL_SHIPWRECKED = "It'll sail me back to unknown shores.",
		PRIMEAPE = "I don't think it throws chocolate at me...",
		PRIMEAPEBARREL = "Those dirty monkeys live here.",
		RAFT = "It wasn't very creative of me.", -- Winnie's right. After all, green is not a creative color.
		REDBARREL = "That symbol means \"danger\".",
		ROCK_CHARCOAL = "I wonder who Santa gave this to.",
		ROCK_OBSIDIAN = "Is that lava inside it?",
		ROWBOAT = "Just like my old toy boat, but bigger.",
		SAIL = "Makes my boat go faster and faster.",
		SAIL_STICK = "I feel horrible holding this...",
		SAND = "Don't you dare get in my shoes ever again!",
		SANDBAG = "Grandpa used to put these around our house on flood season.",
		SANDBAGSMALL = "Grandpa used to put these around our house on flood season.",
		SANDBAG_ITEM = "I'm still not sure how this all fits in my pockets.",
		SANDHILL = "Lots of sand huddled in one place.",
		SAND_CASTLE =
		{
			GENERIC = "I'm sure grandpa would have loved it.",
			SAND = "It eventually goes with the flow.",
		},
		SEAGULL = "It looks kind of angry...",
		SEAGULL_WATER = "A weird bird that likes water.",
		SEASACK = "This makes me feel bad...",
		SEASHELL = "I like picking shells on the sea-side.",
		SEASHELL_BEACHED = "Oh look! A shell!",
		SEATRAP = "I shouldn't use this.",
		SEAWEED = "The land makes weed. Why can't the ocean make weed too?",
		SEAWEED_COOKED = "Looks tasty.",
		SEAWEED_DRIED = "Looks like paper.",
		SEAWEED_PLANTED = "Hi there, sea plant.",
		SHARKITTEN = "You're adorable!",
		SHARKITTENSPAWNER =
		{
			GENERIC = "Hey, it looks like a shark fin!",
			INACTIVE = "Hello, kitties? Are you there?",
		},
		SHARK_FIN = "It cuts through the water and the air.",
		SHARK_GILLS = "I feel horrible...",
		SHARK_TEETHHAT = "It... helps me clear my thoughts, somehow.",
		SHARX = "Bad! Bad fishie!",
		SLOTMACHINE = "Grandpa says betting is wrong.",
		SNAKE = "Hey look! A ssssnake!",
		SNAKEDEN =
		{
			BURNT = "The snakes are homeless now...",
			CHOPPED = "I destroyed their home...",
			GENERIC = "The snakes live there.",
		},
		SNAKEOIL = "I think I've been scammed...",
		SNAKESKIN = "Snake's clothing.",
		SNAKESKINHAT = "Water doesn't like snake clothes.",
		--SNAKE_FIRE = "Snake-y!", this isn't in the game 
		SNAKE_POISON = "Yellow means danger, right?",
		SOLOFISH = "Bark bark!", --Dogfish
		SPEARGUN = "I can make it rain spears on meanies.",
		SPEARGUN_POISON = "I added sickness to it.",
		SPEAR_OBSIDIAN = "Pointy fire stick.",
		SPEAR_POISON = "Pointy sickness stick.",
		SPOILED_FISH = "Ew... furry fish...",
		STUNGRAY = "I smell something rotten...",
		SUNKEN_BOAT =
		{
			ABANDONED = "Where did he go?",
			GENERIC = "Hey there, parrot!",
		},
		SUNKEN_BOAT_BURNT = "That parrot was really unlucky...",
		SUNKEN_BOAT_TRINKET_1 = "Is this... some kind of toy?", -- Sextant
		SUNKEN_BOAT_TRINKET_2 = "A cute toy boat.", -- Toy Boat
		SUNKEN_BOAT_TRINKET_3 = "It's soaked wet.", -- Soaked Candle
		SUNKEN_BOAT_TRINKET_4 = "What kind of toy is this?", -- Sea Worther
		SUNKEN_BOAT_TRINKET_5 = "Old and musty. And I don't even have the other foot.", -- Old Boot
		SUPERTELESCOPE = "I spy with my shark-telescope eye...",
		SWEET_POTATO = "Hmm. Crunchy.",
		SWEET_POTATO_COOKED = "I liked it better before cooking it.",
		SWEET_POTATO_PLANTED = "I don't think that's a carrot.",
		SWEET_POTATO_SEEDS = "I know what'll grow.",
		SWORDFISH = "Why can't we be friends?",
		TELEPORTATO_SW_BASE = "It looks like it could break at any moment.",
		TELEPORTATO_SW_BOX = "What can I do with this?", -- Screw thing
		TELEPORTATO_SW_CRANK = "I wonder if I could tickle others with this...",
		TELEPORTATO_SW_POTATO = "I don't understand.",
		TELEPORTATO_SW_RING = "It would hurt if I used this as a hula hoop.",
		TELESCOPE = "I wonder if I could see my home with this...",
		THATCHPACK = "Thatch's a pretty small pack.",
		TIDALPOOL = "That looks big enough for me to swim on.",
		TIDAL_PLANT = "Green-y and leaf-y.",
		TIGERSHARK = "Bad kitty!",
		TOUCAN = "Toucan play this game.",
		TRAWLNET = "The fishies get stuck in the net.",
		TRAWLNETDROPPED =
		{
			GENERIC = "I hope no fishies got hurt.",
			SOON = "Is it getting bigger?",
			SOONISH = "I wonder what I'll be getting...",
		},
		TREASURECHEST =
		{
			BURNT = "No treasures for me.",
			GENERIC = "Hey, I found a treasure!",
		},
		TRIDENT = "Will it help me control the seas?",
		TROPICALFAN = "Tropical tickling.",
		TROPICAL_FISH = "Poor fishie.",
		TUNACAN = "Doesn't look tasty.",
		TURBINE_BLADES = "Like those an octocopter would use.",
		TURD_SANDY = "It keeps getting inside my shoes.",
		TURF_ASH = "It makes me sneeze.",
		TURF_BADLANDS = "Yet another ground type.",
		TURF_BEACH = "Sandy.",
		TURF_JUNGLE = "Filled with adventures and stories long-gone.",
		TURF_SWAMP = "Kind of ew.", -- Note: This is not TURF_MARSH where Reeds are found.
		TURF_VOLCANO = "How does it not melt my pockets?",
		TURF_MAGMAFIELD = "It burns my feet.",
		TURF_TIDALMARSH = "It's water-logged!",
		TURF_MEADOW = "Pieces of that calm and peaceful meadow.",
		TURF_SNAKESKINFLOOR = "Made from ssssnakes.",
		TWISTER = "No! It'll blow my bonnet away!",
		TWISTER_SEAL = "Are you calm now?",
		VENOMGLAND = "Full of sickness.",
		VINE = "I hope I don't get any splinters from this.",
		VOLCANO = "It's so big!",
		VOLCANOSTAFF = "Brings down the wrath of the heavens.",
		VOLCANO_ALTAR =
		{
			GENERIC = "What's that big bowl for?",
			OPEN = "I don't have any cereal to fill that with.",
		},
		VOLCANO_ALTAR_BROKEN = "It won't work anymore.",
		VOLCANO_EXIT = "I want to go back home.",
		VOLCANO_SHRUB = "How's it not burnt up?",
		WALLYINTRO_DEBRIS = "Just my luck.",
		WALL_LIMESTONE = "It's more resistant than it looks.",
		WALL_LIMESTONE_ITEM = "I can make a little house.",
		WHALE_BLUE = "It needs some cheering up.",
		WHALE_BUBBLES = "Bubbleprints?",
		WHALE_CARCASS_BLUE = "I'm sorry...",
		WHALE_CARCASS_WHITE = "I hope you can forgive me...",
		WHALE_WHITE = "Moby?",
		WILBUR_CROWN = "A crown... but for what king?",
		WILBUR_UNLOCK = "He looks important, I think.",
		WILDBOREGUARD = "I don't speak bore latin.",
		WILDBOREHOUSE = "Looks small, but comfy.",
		WIND_CONCH = "The wind obeys me!",
		WOODLEGS_CAGE = "Don't worry sir, I'll help you out!",
		WOODLEGS_KEY1 = "What does it open?",
		WOODLEGS_KEY2 = "What does it open?",
		WOODLEGS_KEY3 = "What does it open?",
	},
}
